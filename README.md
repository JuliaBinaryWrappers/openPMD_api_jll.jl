...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/31eb0ac4d75588625316453b4509c7ac2f2a424d/O/openPMD_api/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/eschnett/openPMD-api/archive/84bce33ffe0f730ac13562a6f0ff142222efff95.tar.gz (SHA256 checksum: `ab394d567946b34a0a163d02c6d237f2339cddaa29dce57716ae326d034da623`)
...
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=glibc, mpi=mpich}` (`armv6l-linux-gnueabihf-cxx03-julia_version+1.9.0-mpi+mpich`)
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=glibc, mpi=mpitrampoline}` (`armv6l-linux-gnueabihf-cxx03-julia_version+1.9.0-mpi+mpitrampoline`)
...
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=glibc, mpi=mpich}` (`armv6l-linux-gnueabihf-cxx11-julia_version+1.9.0-mpi+mpich`)
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=glibc, mpi=mpitrampoline}` (`armv6l-linux-gnueabihf-cxx11-julia_version+1.9.0-mpi+mpitrampoline`)
...
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=musl, mpi=mpich}` (`armv6l-linux-musleabihf-cxx03-julia_version+1.9.0-mpi+mpich`)
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=musl, mpi=openmpi}` (`armv6l-linux-musleabihf-cxx03-julia_version+1.9.0-mpi+openmpi`)
...
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=musl, mpi=mpich}` (`armv6l-linux-musleabihf-cxx11-julia_version+1.9.0-mpi+mpich`)
* `Linux armv6l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=musl, mpi=openmpi}` (`armv6l-linux-musleabihf-cxx11-julia_version+1.9.0-mpi+openmpi`)
...
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=glibc, mpi=mpich}` (`armv7l-linux-gnueabihf-cxx03-julia_version+1.9.0-mpi+mpich`)
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=glibc, mpi=mpitrampoline}` (`armv7l-linux-gnueabihf-cxx03-julia_version+1.9.0-mpi+mpitrampoline`)
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=glibc, mpi=openmpi}` (`armv7l-linux-gnueabihf-cxx03-julia_version+1.9.0-mpi+openmpi`)
...
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=glibc, mpi=mpich}` (`armv7l-linux-gnueabihf-cxx11-julia_version+1.9.0-mpi+mpich`)
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=glibc, mpi=mpitrampoline}` (`armv7l-linux-gnueabihf-cxx11-julia_version+1.9.0-mpi+mpitrampoline`)
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=glibc, mpi=openmpi}` (`armv7l-linux-gnueabihf-cxx11-julia_version+1.9.0-mpi+openmpi`)
...
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=musl, mpi=mpich}` (`armv7l-linux-musleabihf-cxx03-julia_version+1.9.0-mpi+mpich`)
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx03, julia_version=1.9.0, libc=musl, mpi=openmpi}` (`armv7l-linux-musleabihf-cxx03-julia_version+1.9.0-mpi+openmpi`)
...
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=musl, mpi=mpich}` (`armv7l-linux-musleabihf-cxx11-julia_version+1.9.0-mpi+mpich`)
* `Linux armv7l {call_abi=eabihf, cxxstring_abi=cxx11, julia_version=1.9.0, libc=musl, mpi=openmpi}` (`armv7l-linux-musleabihf-cxx11-julia_version+1.9.0-mpi+openmpi`)
