# Autogenerated wrapper script for openPMD_api_jll for powerpc64le-linux-gnu-cxx11-julia_version+1.8.0
...
function __init__()
    JLLWrappers.@generate_init_header(ADIOS2_jll, CompilerSupportLibraries_jll, MPICH_jll, libcxxwrap_julia_jll)
