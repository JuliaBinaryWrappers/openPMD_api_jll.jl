# Autogenerated wrapper script for openPMD_api_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libopenPMD_jl, "@rpath/libopenPMD_jl.dylib")
function __init__()
