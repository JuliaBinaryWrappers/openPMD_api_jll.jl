# Autogenerated wrapper script for openPMD_api_jll for armv6l-linux-musleabihf-cxx03-julia_version+1.7.0
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, MPICH_jll, libcxxwrap_julia_jll)
