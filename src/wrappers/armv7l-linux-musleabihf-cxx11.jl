# Autogenerated wrapper script for openPMD_api_jll for armv7l-linux-musleabihf-cxx11
...
JLLWrappers.@declare_library_product(libopenPMD_jl, "libopenPMD_jl.so")
function __init__()
